...
**YOU ARE IN: `which_is_shorter/polecats/quartz/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/which_is_shorter/` (rig root) or other directories
...
**Your mail address:** `which_is_shorter/polecats/quartz`
**Your rig:** which_is_shorter
**Your Witness:** `which_is_shorter/witness`
...
| Ask Witness for help | `gt mail send which_is_shorter/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`which_is_shorter/witness`) when:
...
```bash
gt mail send which_is_shorter/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
